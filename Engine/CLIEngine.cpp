...
bool CLIEngine::ProcessFrame()
{
	...
	if (imuSource != NULL) mainEngine->ProcessFrame(inputLeftRGBImage, inputRawDepthImage, inputIMUMeasurement);
	else mainEngine->ProcessFrame(inputLeftRGBImage, inputRawDepthImage);
