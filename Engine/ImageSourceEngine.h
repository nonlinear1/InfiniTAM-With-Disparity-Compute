...
namespace InfiniTAM
{
	namespace Engine
	{
		...
		public:
			...
			virtual void getImages(ITMUChar4Image *leftRgb, ITMUChar4Image *rightRgb, ITMShortImage *rawDepth) = 0;
		...
		private:
			...
			char leftRgbImageMask[BUF_SIZE];
			char rightRgbImageMask[BUF_SIZE];
            char depthImageMask[BUF_SIZE];

            ITMUChar4Image *cached_left_rgb;
            ITMUChar4Image *cached_right_rgb;
		...
		public:
			...
			ImageFileReader(const char *calibFilename, const char *leftRgbImageMask, 
                            const char *rightRgbImageMask, const char *depthImageMask);
			~ImageFileReader();
            
			bool hasMoreImages(void);
			void getImages(ITMUChar4Image *leftRgb, ITMUChar4Image *rightRgb, ITMShortImage *rawDepth);
		...
		public:
			RawFileReader(const char *calibFilename, const char *leftRgbImageMask, const char *rightRgbImageMask, 
